...
import hashlib
import random
SHSpad1 = '\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00' + '\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00' + '\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
SHSpad2 = '\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2' + '\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2' + '\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2\xf2'
Magic1 = 'This is the MPPE M' + 'aster Key'
Magic2 = 'On the client side, ' + 'this is th' + 'e send key' + '; on the s' + 'erver side' + ', it is th' + 'e receive ' + 'key.'
Magic3 = 'On the client side, ' + 'this is th' + 'e receive ' + 'key; on th' + 'e server s' + 'ide, it is' + ' the send ' + 'key.'
...
def gen_radius_encrypt_keys(send_key, recv_key, secret, request_authenticator):
    ...
    _send_key = send_salt + radius_encrypt_keys(create_plain_text(send_key), secret, request_authenticator, send_salt)
    _recv_key = recv_salt + radius_encrypt_keys(create_plain_text(recv_key), secret, request_authenticator, recv_salt)
