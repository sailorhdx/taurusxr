...
class LogTrace(object):
    radius_key = 'taurusxradius.syslog.trace.radius.{0}'.format
    userlog_key = 'taurusxradius.syslog.trace.userlog.{0}'.format
    trace_key = 'taurusxradius.syslog.trace.{0}'.format
