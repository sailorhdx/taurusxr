...
from taurusxradius.taurusxlib import utils, apiutils
...
from taurusxradius.taurusxlib import db_session as session
from taurusxradius.modules import settings
...
class BaseHandler(cyclone.web.RequestHandler):
    ...
    def set_remerber_user(self, user, pwd):
        self.session['taurusxee_wlan_user'] = user
        self.session['taurusxee_wlan_pwd'] = pwd
        self.session.save()

    def get_remember_user(self):
        user = self.session.get('taurusxee_wlan_user')
        pwd = self.session.get('taurusxee_wlan_pwd')
        return (user, pwd)
