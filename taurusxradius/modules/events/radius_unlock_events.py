...
from taurusxradius.txradius import statistics
...
from taurusxradius.modules.radius import radius_acct_stop
from taurusxradius.modules.events.settings import DBSYNC_STATUS_ADD
from taurusxradius.modules.events.settings import CLEAR_ONLINE_EVENT
from taurusxradius.txradius import authorize
...
class RadiusEvents(BasicEvent):
    dictionary = dictionary.Dictionary(os.path.join(os.path.dirname(taurusxradius.__file__), 'dictionarys/dictionary'))
