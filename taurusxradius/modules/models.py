...
from taurusxradius.taurusxlib import utils, dispatch, storage
...
class SystemCache(DeclarativeBase):
    ...
    value = Column(u'_value', Unicode(length=2048), nullable=False, doc=u'cache value')
...
class TrArea(DeclarativeBase):
    ...
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'社区编号')
    node_id = Column(u'node_id', Unicode(length=32), nullable=False, doc=u'区域id')
...
class TrOperator(DeclarativeBase):
    ...
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'操作员id')
...
class TrOperatorNodes(DeclarativeBase):
    ...
    node_id = Column(u'node_id', Unicode(length=32), primary_key=True, autoincrement=False, nullable=False, doc=u'区域id')
    sync_ver = Column('sync_ver', Unicode(length=16), nullable=True, doc=u'同步版本时间戳')
...
class TrOperatorProducts(DeclarativeBase):
    ...
    __table_args__ = {}
    operator_name = Column(u'operator_name', Unicode(32), primary_key=True, nullable=False, doc=u'操作员名称')
    product_id = Column(u'product_id', Unicode(length=32), primary_key=True, nullable=False, doc=u'资费ID')
    sync_ver = Column('sync_ver', Unicode(length=16), nullable=True, doc=u'同步版本时间戳')
...
class TrOperatorRule(DeclarativeBase):
    ...
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'权限id')
    operator_name = Column(u'operator_name', Unicode(32), nullable=False, doc=u'操作员名称')
...
class TrBas(DeclarativeBase):
    ...
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'设备id')
    nas_id = Column(u'nas_id', Unicode(length=128), nullable=True, doc=u'设备标识')
    ...
    portal_vendor = Column(u'portal_vendor', Unicode(length=64), nullable=True, doc=u'portal协议')
    ...
    ac_port = Column(u'ac_port', INTEGER(), nullable=False, default=2000, doc=u'AC 端口')
    coa_port = Column(u'coa_port', INTEGER(), nullable=False, default=3799, doc=u'CoA 端口')
...
class TrRoster(DeclarativeBase):
    ...
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'黑白名单id')
...
class TrCustomer(DeclarativeBase):
    ...
    __table_args__ = {}
    customer_id = Column('customer_id', Unicode(length=32), primary_key=True, doc=u'用户id')
    agency_id = Column(u'agency_id', Unicode(length=32), nullable=True, index=True, doc=u'代理商账户id')
    node_id = Column('node_id', Unicode(length=32), nullable=False, index=True, doc=u'区域id')
    area_id = Column('area_id', Unicode(length=32), nullable=True, index=True, doc=u'社区id')
    ...
    wechat_oid = Column(u'wechat_oid', Unicode(64), nullable=True, doc=u'微信绑定')
...
class TrCustomerOrder(DeclarativeBase):
    """
    订购信息表(交易记录)
    pay_status交易支付状态：0-未支付，1-已支付，2-已对账, 3-已取消
    after_account_data: 交易前用户账号数据
    before_account_data: 交易后用户账号数据, 如果交易完成，该数据覆盖当前用户数据
    """
    __tablename__ = 'tr_customer_order'
    __table_args__ = {}
    order_id = Column('order_id', Unicode(length=32), primary_key=True, nullable=False, doc=u'订单id')
    customer_id = Column('customer_id', Unicode(length=32), nullable=False, index=True, doc=u'用户id')
    product_id = Column('product_id', Unicode(length=32), nullable=False, index=True, doc=u'资费id')
    ...
    pay_status = Column('pay_status', INTEGER(), nullable=False, index=True, doc=u'支付状态')
    accept_id = Column('accept_id', Unicode(length=32), nullable=False, doc=u'受理id')
    ...
    after_account_data = Column('after_account_data', Unicode(length=1024), nullable=True, doc=u'交易前用户账号数据')
    before_account_data = Column('before_account_data', Unicode(length=1024), nullable=True, doc=u'交易后用户账号数据')
    create_time = Column('create_time', Unicode(length=19), nullable=False, index=True, doc=u'交易时间')
    check_time = Column('check_time', Unicode(length=19), nullable=True, index=True, doc=u'创建时间')
    stat_year = Column('stat_year', Unicode(length=4), nullable=True, index=True, doc=u'统计年(允余)')
    stat_month = Column('stat_month', Unicode(length=7), nullable=True, index=True, doc=u'统计月(允余)')
    stat_day = Column('stat_day', Unicode(length=10), nullable=True, index=True, doc=u'统计日(允余)')
    sync_ver = Column('sync_ver', Unicode(length=16), nullable=True, doc=u'同步版本时间戳')


class TrCustomerBill(DeclarativeBase):
    """客户账单
    status 状态：0-未付，1-已付，2-已对账
    """
    __tablename__ = 'tr_customer_bill'
    __table_args__ = {}
    id = Column('id', Unicode(length=32), primary_key=True, nullable=False, doc=u'账单id')
    customer_id = Column('customer_id', Unicode(length=32), nullable=False, doc=u'用户id')
    account_number = Column('account_number', Unicode(length=32), nullable=False, doc=u'上网账号')
    month = Column('month', Unicode(length=32), nullable=False, doc=u'资费id')
    bill_fee = Column('bill_fee', INTEGER(), nullable=False, doc=u'账单费用分')
    bill_flows = Column('bill_flows', INTEGER(), nullable=False, doc=u'账单总流量(kb)')
    bill_times = Column('bill_times', INTEGER(), nullable=False, doc=u'账单总时长(小时)')
    bill_days = Column('bill_days', INTEGER(), nullable=False, doc=u'账单总计费天数')
    status = Column('status', INTEGER(), nullable=False, doc=u'状态')
    bill_desc = Column('bill_desc', Unicode(length=255), doc=u'账单描述备注')
    create_time = Column('create_time', Unicode(length=19), nullable=False, doc=u'出账时间')
    check_time = Column('check_time', Unicode(length=19), nullable=False, doc=u'对账时间')
    sync_ver = Column('sync_ver', Unicode(length=16), nullable=True, doc=u'同步版本时间戳')
...
class TrAccount(DeclarativeBase):
    ...
    用户状态 0:"未激活",1:"正常", 2:"停机" , 3:"销户", 4:"到期",5:"预开户"
    """
    ...
    customer_id = Column('customer_id', Unicode(length=32), nullable=False, index=True, doc=u'用户id')
    product_id = Column('product_id', Unicode(length=32), nullable=False, index=True, doc=u'资费id')
    group_id = Column('group_id', Unicode(length=32), doc=u'用户组id')
    password = Column('password', Unicode(length=128), nullable=False, doc=u'上网密码')
    status = Column('status', INTEGER(), nullable=False, index=True, doc=u'用户状态')
    ...
    domain = Column('domain', Unicode(length=32), doc=u'用户域名')
...
class TrProduct(DeclarativeBase):
    ...
    __table_args__ = {}
    id = Column('id', Unicode(length=32), primary_key=True, autoincrement=1, nullable=False, doc=u'资费id')
    ...
    ispub = Column('ispub', INTEGER(), default=0, doc=u'是否发布为自助资费0 不发布,1 发布 ')
...
class TrProductAttr(DeclarativeBase):
    ...
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'属性id')
    product_id = Column('product_id', Unicode(length=32), nullable=False, doc=u'资费id')
    attr_type = Column('attr_type', INTEGER(), default=1, doc=u'属性类型，0，一般；1，radius属性')
    attr_name = Column(u'attr_name', Unicode(length=255), nullable=False, doc=u'属性名')
    attr_value = Column(u'attr_value', Unicode(length=255), nullable=False, doc=u'属性值')
    attr_desc = Column(u'attr_desc', Unicode(length=255), doc=u'属性描述')
...
class TrBilling(DeclarativeBase):
    ...
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'计费id')
    ...
    stat_year = Column('stat_year', Unicode(length=4), nullable=True, doc=u'统计年(允余)')
    stat_month = Column('stat_month', Unicode(length=7), nullable=True, doc=u'统计月(允余)')
    stat_day = Column('stat_day', Unicode(length=10), nullable=True, doc=u'统计日(允余)')
    sync_ver = Column('sync_ver', Unicode(length=16), nullable=True, doc=u'同步版本时间戳')
...
class TrTicket(DeclarativeBase):
    ...
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'日志id')
    account_number = Column(u'account_number', Unicode(length=253), nullable=False, index=True, doc=u'上网账号')
    ...
    acct_session_id = Column(u'acct_session_id', Unicode(length=253), nullable=False, doc=u'会话id')
    acct_session_time = Column(u'acct_session_time', INTEGER(), nullable=False, doc=u'会话时长')
    acct_start_time = Column(u'acct_start_time', Unicode(length=19), nullable=False, index=True, doc=u'会话开始时间')
    acct_stop_time = Column(u'acct_stop_time', Unicode(length=19), nullable=False, index=True, doc=u'会话结束时间')
    acct_terminate_cause = Column(u'acct_terminate_cause', INTEGER(), doc=u'会话中止原因')
    mac_addr = Column(u'mac_addr', Unicode(length=128), index=True, doc=u'mac地址')
    ...
    framed_ipaddr = Column(u'framed_ipaddr', Unicode(length=15), index=True, doc=u'IP地址')
    nas_class = Column(u'nas_class', Unicode(length=253), doc=u'bas class')
    nas_addr = Column(u'nas_addr', Unicode(length=15), nullable=False, index=True, doc=u'bas地址')
...
class TrOnline(DeclarativeBase):
    ...
    __table_args__ = {'mysql_engine': 'MEMORY'}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'在线id')
...
class TrProductCharges(DeclarativeBase):
    ...
    __table_args__ = {}
    product_id = Column('product_id', Unicode(length=32), primary_key=True, nullable=False, doc=u'资费id')
    charge_code = Column(u'charge_code', Unicode(length=32), primary_key=True, nullable=False, doc=u'收费项编码')
    sync_ver = Column('sync_ver', Unicode(length=16), nullable=True, doc=u'同步版本时间戳')
...
class TrCustomerNote(DeclarativeBase):
    ...
    charge_values = Column(u'charge_values', Unicode(255), nullable=False, doc=u'收费项')
...
class TrPrintTemplate(DeclarativeBase):
    ...
    tpl_content = Column(u'tpl_content', Unicode(length=4000), doc=u'模板内容')
    sync_ver = Column('sync_ver', Unicode(length=16), nullable=True, doc=u'同步版本时间戳')
...
class TrPrintTemplateTypes(DeclarativeBase):
    ...
    __table_args__ = {}
    tpl_id = Column(u'tpl_id', Unicode(length=32), primary_key=True, autoincrement=False, nullable=False, doc=u'模板id')
...
class TrIssues(DeclarativeBase):
    ...
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'工单id')
    account_number = Column(u'account_number', Unicode(length=32), nullable=False, doc=u'上网账号')
...
class TrIssuesAppend(DeclarativeBase):
    ...
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'工单id')
    issues_id = Column('issues_id', Unicode(length=32), nullable=False, doc=u'工单id')
...
class TrIssuesFlow(DeclarativeBase):
    ...
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'工单流id')
    issues_id = Column('issues_id', Unicode(length=32), nullable=False, doc=u'工单id')
    operator_name = Column(u'operator_name', Unicode(32), nullable=False, doc=u'操作员')
...
class TrBuilder(DeclarativeBase):
    ...
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'id')
    builder_name = Column(u'builder_name', Unicode(64), nullable=False, doc=u'服务人员姓名')
    builder_phone = Column(u'builder_phone', Unicode(64), nullable=False, doc=u'服务人员电话')
    wechat_oid = Column(u'wechat_oid', Unicode(64), nullable=True, doc=u'微信openid')
    mp_qrcode = Column(u'mp_qrcode', Unicode(length=255), nullable=True, doc=u'专用微信二维码')
    mp_active_code = Column(u'mp_active_code', Unicode(length=32), nullable=True, doc=u'微信激活码')
    mp_active_status = Column(u'mp_active_status', INTEGER(), default=0, nullable=False)
    sync_ver = Column('sync_ver', Unicode(length=16), nullable=True, doc=u'同步版本时间戳')
...
class TrAreaBuilder(DeclarativeBase):
    ...
    __table_args__ = {}
    area_id = Column('area_id', Unicode(length=32), autoincrement=False, primary_key=True, nullable=False, doc=u'区域id')
    builder_id = Column(u'builder_id', Unicode(32), primary_key=True, nullable=False, doc=u'服务人员id')
    sync_ver = Column('sync_ver', Unicode(length=16), nullable=True, doc=u'同步版本时间戳')


class TrAgency(DeclarativeBase):
    """  代理商表
    """
    __tablename__ = 'tr_agency'
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'id')
    agency_name = Column(u'agency_name', Unicode(length=32), doc=u'代理商账户')
    operator_name = Column(u'operator_name', Unicode(32), nullable=False, doc=u'操作员名称')
    contact = Column(u'contact', Unicode(length=32), nullable=False, doc=u'联系人')
    mobile = Column(u'mobile', Unicode(length=32), nullable=True, doc=u'手机号码')
    amount = Column(u'amount', INTEGER(), default=0, nullable=False, doc=u'预存余额')
    share_rate = Column(u'share_rate', INTEGER(), nullable=False, doc=u'分成比例')
    create_time = Column(u'create_time', Unicode(length=19), nullable=False, doc=u'创建时间')
    update_time = Column(u'update_time', Unicode(length=19), nullable=True, doc=u'更新时间')
    agency_desc = Column(u'agency_desc', Unicode(length=128), nullable=True, doc=u'描述')
    sync_ver = Column('sync_ver', Unicode(length=16), nullable=True, doc=u'同步版本时间戳')


class TrAgencyShare(DeclarativeBase):
    """  代理商分成记录
    """
    __tablename__ = 'tr_agency_share'
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'id')
    order_id = Column('order_id', Unicode(length=32), nullable=False, doc=u'订单id')
    agency_id = Column(u'agency_id', Unicode(length=32), nullable=False, doc=u'代理商账户id')
    share_rate = Column(u'share_rate', INTEGER(), nullable=False, doc=u'分成比例')
    share_fee = Column('share_fee', INTEGER(), default=0, nullable=True, doc=u'代理分成费用')
    create_time = Column(u'create_time', Unicode(length=19), nullable=False, doc=u'创建时间')
    sync_ver = Column('sync_ver', Unicode(length=16), nullable=True, doc=u'同步版本时间戳')


class TrAgencyOrder(DeclarativeBase):
    """  代理商充值记录
    fee_type ： recharge-充值  share-分成  cost-扣费 sharecost 分摊扣费
    """
    __tablename__ = 'tr_agency_order'
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'id')
    agency_id = Column(u'agency_id', Unicode(length=32), doc=u'代理商账户id')
    fee_type = Column('fee_type', Unicode(length=16), nullable=False, doc=u'费用类型')
    fee_value = Column('fee_value', INTEGER(), nullable=False, doc=u'当前实缴费用')
    fee_total = Column('fee_total', INTEGER(), nullable=False, doc=u'当前缴费后余额')
    fee_desc = Column('fee_desc', Unicode(length=255), doc=u'费用描述')
    create_time = Column('create_time', Unicode(length=19), nullable=False, doc=u'交易时间')
    sync_ver = Column('sync_ver', Unicode(length=16), nullable=True, doc=u'同步版本时间戳')


class TrDomain(DeclarativeBase):
    """域属性表 """
    __tablename__ = 'tr_domain'
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'id')
...
class TrDomainAttr(DeclarativeBase):
    """portal模版属性 """
    __tablename__ = 'tr_domain_attr'
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'id')
    ...
    attr_desc = Column(u'attr_desc', Unicode(length=255), doc=u'属性描述')
    sync_ver = Column('sync_ver', Unicode(length=16), nullable=True, doc=u'同步版本时间戳')
    UniqueConstraint('domain_code', 'attr_name', name='unique_domain_attr')


class TrDomainAp(DeclarativeBase):
    """Ap信息表 """
    __tablename__ = 'tr_domain_ap'
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'id')
    domain_code = Column(u'domain_code', Unicode(length=16), nullable=False, doc=u'域编码')
    guid = Column(u'guid', Unicode(length=32), nullable=False, index=True, doc=u'guid')
    ssid = Column(u'ssid', Unicode(length=32), nullable=False, index=True, doc=u'ssid')
    sync_ver = Column('sync_ver', Unicode(length=16), nullable=True, doc=u'同步版本时间戳')
    ap_desc = Column(u'ap_desc', Unicode(length=255), nullable=True, doc=u'ap描述')


class TrValCard(DeclarativeBase):
    """
    点卡／充值卡

    卡类型：
    balance: 余额卡, 余额对等 1点=1元
    product: 资费卡，余额无效，只能用于特定资费
    flowlen: 流量卡，G
    timelen: 时长卡，小时
    """
    __tablename__ = 'tr_val_card'
    __table_args__ = {}
    card_code = Column(u'card_code', Unicode(length=32), primary_key=True, doc=u'(主键)卡号')
    card_type = Column(u'card_type', Unicode(length=16), nullable=False, doc=u'卡类型')
    card_bn = Column(u'card_bn', Unicode(length=16), nullable=False, index=True, doc=u'卡发行批次')
    card_pwd = Column(u'card_pwd', Unicode(length=64), nullable=False, doc=u'卡密码')
    product_tag = Column('product_tag', Unicode(length=64), nullable=True, index=True, doc=u'关联资费标签')
    credit = Column('credit', INTEGER(), nullable=False, default=0, doc=u'点数')
    flowlen = Column('flowlen', INTEGER(), nullable=False, default=0, doc=u'点数')
    timelen = Column('timelen', INTEGER(), nullable=False, default=0, doc=u'点数')
    fee_price = Column('fee_price', Unicode(length=16), nullable=False, doc=u'零售价')
    status = Column('status', SMALLINT(), nullable=False, index=True, doc=u'状态 0 初始化 1 已激活 2 已使用')
    customer_id = Column('customer_id', Unicode(length=32), index=True, nullable=True, doc=u'客户id')
    active_time = Column('active_time', Unicode(length=19), nullable=True, doc=u'激活时间')
...
class TrRepliSyncStatus(DeclarativeBase):
    __tablename__ = 'tr_repli_sync_status'
    __table_args__ = {}
    id = Column(u'id', Unicode(length=32), primary_key=True, nullable=False, doc=u'id')
    table_name = Column(u'table_name', Unicode(length=128), nullable=True, doc=u'数据库表名')
    action = Column(u'action', Unicode(length=16), nullable=False, doc=u'同步操作 update delete')
    pkeys = Column('pkeys', Unicode(length=255), nullable=False, doc=u'主键值')
    content = Column('content', TEXT(), nullable=False, doc=u'同步数据内容')
    error = Column('error', Unicode(length=512), nullable=True, doc=u'同步错误')
    sync_status = Column('sync_status', INTEGER(), nullable=False, default=0, doc=u'同步状态 0 未同步 1 已经同步 2 同步异常')
    sync_times = Column('sync_times', INTEGER(), nullable=False, default=0, doc=u'同步次数')
    sync_ver = Column('sync_ver', Unicode(length=16), nullable=True, doc=u'同步版本时间戳')
    create_time = Column('create_time', Unicode(length=19), nullable=False, doc=u'首次同步时间')
    last_sync = Column('last_sync', Unicode(length=19), nullable=False, doc=u'最后同步时间')
...
def warp_sdel_obj(table_name, pkeys):
    sobj = storage.Storage()
    sobj.table_name = table_name
    sobj.action = 'delete'
    sobj.pkeys = obj2json(pkeys)
    sobj.content = '{}'
    sobj.sync_ver = 0
    return sobj
...
for tabcls in SYNC_TABLES:
    ...
    @event.listens_for(tabcls, 'after_insert', raw=True)
    def add_new_sync_status(mapper, connection, target):
        dispatch.pub('add_sync_status', warp_sobj('add', target.object))


    @event.listens_for(tabcls, 'after_update', raw=True)
    def add_update_sync_status(mapper, connection, target):
        dispatch.pub('add_sync_status', warp_sobj('update', target.object))