...
if os.environ.get('LICENSE_TYPE') != 'community':
    ...
    @permit.route('/usrportal/product/vcardcharge')

    class UsrPortalVcardChargeOrderHandler(BaseHandler):
        """ 发起充值卡流量充值
        """
        ...
        def get(self):
            ...
            self.render('profile_vcard_charge_modal_form.html', form=form)
