...
@permit.route('/usrportal/account')
...
class AccountHandler(BaseHandler):
    ...
    def get(self):
        ...
        get_product_attr_val = lambda an: self.db.query(models.TrProductAttr.attr_value).filter_by(product_id=user.product_id, attr_name=an).scalar()
        return self.render('profile_account.html', customer=customer, user=user, orders=orders, get_attr_val=get_attr_val, get_product_attr_val=get_product_attr_val, type_map=type_map)


@permit.route('/usrportal/account/release')
