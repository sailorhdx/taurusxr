...
import sys, os
sys.path.insert(0, '../../')
from taurusxradius.txradius import message, client
from taurusxradius.txradius.radius import dictionary, packet
...
def test_auth():
    _dict = dictionary.Dictionary(os.path.join(os.path.dirname(__file__), '../dictionary/dictionary'))
