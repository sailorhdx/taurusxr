...
# coding=utf-8
import struct
from taurusxradius.txradius.radius import tools
IK_RAD_PKG_VER = 1
IK_RAD_PKG_AUTH = 1
IK_RAD_PKG_USR_PWD_TAG = 17
IK_RAD_PKG_USR_NAME_TAG = 18
IK_RAD_PKG_USR_CMD_TAG = 19
IK_RAD_PKG_CMD_ARGS_TAG = 20
