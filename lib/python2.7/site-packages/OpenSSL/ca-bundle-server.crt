##
##  ca-bundle-server.crt -- Bundle of CA Root Certificates
##
##  Trusted uses: Server authentication
##
...
##  this ca-bundle-server.crt file.  However, we do recognize and appreciate the
