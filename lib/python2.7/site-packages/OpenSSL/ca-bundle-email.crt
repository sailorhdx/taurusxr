##
##  ca-bundle-email.crt -- Bundle of CA Root Certificates
##
##  Trusted uses: EMail protection
##
##  This is a bundle of X.509 certificates of public Certificate Authorities
##  (CA).  These were automatically extracted and converted into PEM format
##  from Mozilla's root certificates file (certdata.txt), which can be found
##  in the Mozilla source tree at:
##
##      http://mxr.mozilla.org/mozilla-release/source/security/nss/lib/ckfw/builtins/certdata.txt?raw=1
##
##  Mozilla's certificate file (certdata.txt) was last updated on
##
##      2016-04-16 10:08:44+00:00
##
##  For reference, this is the Mozilla copyright notice on certdata.txt:
##
##      This Source Code Form is subject to the terms of the Mozilla Public
##      License, v. 2.0. If a copy of the MPL was not distributed with this
##      file, You can obtain one at http://mozilla.org/MPL/2.0/.
##
##  Since we're not distributing the certdata.txt file itself, we believe
##  that the MPL does not apply to the collection of PEM certificates in
##  this ca-bundle-email.crt file.  However, we do recognize and appreciate the
##  work Mozilla is putting into managing these certificates and would like
##  to thank them for their work.
##
##  Brought to you by:
##
##      eGenix.com Software, Skills and Services GmbH, Langenfeld, Germany
##      http://www.egenix.com/
##      info@egenix.com
##
##  We've put a BSD license on this file, mostly because we need the
##  disclaimers of warranty and liability:
##
##  Copyright (c) 2013-2015, eGenix.com Software GmbH (info@egenix.com)
##
##                         All Rights Reserved.
##
...
##
##  EGENIX.COM DISCLAIMS ALL WARRANTIES WITH REGARD TO THIS SOFTWARE,
...
Certificate:
    ...
    Signature Algorithm: sha256WithRSAEncryption
        Issuer: C=DE, O=Deutscher Sparkassen Verlag GmbH, OU=S-TRUST Certification Services, CN=S-TRUST Universal Root CA
        Validity
...
SHA1 Fingerprint=B1:72:B1:A5:6D:95:F9:1F:E5:02:87:E1:4D:37:EA:6A:44:63:76:8A
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number:
